...
[![npm](https://img.shields.io/npm/v/@berufungirnpm/vel-aut-ducimus.svg)](https://www.npmjs.com/package/@berufungirnpm/vel-aut-ducimus)
...
```ts
import type * as CSS from '@berufungirnpm/vel-aut-ducimus';
...
```js
// @flow strict
import * as CSS from '@berufungirnpm/vel-aut-ducimus';
...
```sh
$ npm install @berufungirnpm/vel-aut-ducimus
```
...
2.  **Have a look in [issues](https://github.com/berufungirnpm/vel-aut-ducimus/issues) to see if an issue already has been filed. If not, create a new one.** To help us out, please refer to any information you have found.
3.  Fix the issue locally with **TypeScript** (Flow further down):
    ...
    - The recommended way is to use **module augmentation**. Here's a few examples:
      ...
      declare module '@berufungirnpm/vel-aut-ducimus' {
